...
<form id="formulario" name="formulario" method="post" action="guardar_cobro.php" target="frame_datos">
        ...
        <script type="text/javascript">
			  ...
			  <div align="center">
					...
					<img src="../img/botonimprimirticket.jpg" width="122" height="22" onClick="imprimir(<? echo $codfactura?>)" border="1" onMouseOver="style.cursor=cursor" id="img" style = "visibility:hidden">
