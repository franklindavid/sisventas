		...
		<div id="pagina">
			...
			<input type="hidden" name="totalfacturas" id="totalfacturas" value="<? echo $totalfacturas?>">
				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						<? $sel_resultado="SELECT codfactura,clientes.nombre as nombre,facturas.fecha as fecha,totalfactura,estado FROM facturas,clientes WHERE facturas.borrado=0 AND facturas.codcliente=clientes.codcliente AND ".$where;
						   ...
						   while ($contador < mysql_num_rows($res_resultado)) { 
								...
								<td width="8%"><div align="right"><? echo number_format(mysql_result($res_resultado,$contador,"totalfactura"),2,".",",")?></div></td>
								...
								<td width="6%"><div align="center"><a href="#"><img src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_factura(<?php echo mysql_result($res_resultado,$contador,"codfactura")?>,<? echo $marcaestado?>)" title="Modificar"></a></div></td>
								<td width="6%"><div align="center"><a href="#"><img src="../img/ver.png" width="16" height="16" border="0" onClick="ver_factura(<?php echo mysql_result($res_resultado,$contador,"codfactura")?>)" title="Visualizar"></a></div></td>
								<td width="6%"><div align="center"><a href="#"><img src="../img/eliminar.png" width="16" height="16" border="0" onClick="eliminar_factura(<?php echo mysql_result($res_resultado,$contador,"codfactura")?>)" title="Eliminar"></a></div></td>
						</tr>
						</tr>
						<? $contador++;
							}
