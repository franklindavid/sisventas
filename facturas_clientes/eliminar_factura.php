...
<html>
	<head>
		...
		function aceptar(codfactura) {
			location.href="guardar_factura.php?codfactura=" + codfactura + "&accion=baja" + "&cadena_busqueda=<? echo $cadena_busqueda?>";
		}
...
$rs_lineas=mysql_query($sel_lineas);
			  ...
			  <? $baseimpuestos=$baseimponible*($iva/100);
				...
				<div id="botonBusqueda">
					<div align="center">
					<img src="../img/botonaceptar.jpg" width="85" height="22" onClick="aceptar(<? echo $codfactura?>)" border="1" onMouseOver="style.cursor=cursor">
