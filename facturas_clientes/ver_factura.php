...
<html>
	<head>
		...
		function efectuarpago(codfactura,codcliente,importe) {
			miPopup = window.open("efectuarpago.php?codfactura="+codfactura+"&codcliente="+codcliente+"&importe="+importe,"miwin","width=500,height=370,scrollbars=yes");	
				...
				<div id="botonBusqueda">
					<div align="center">
					 ...
					 <img src="../img/botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimir(<? echo $codfactura?>)" onMouseOver="style.cursor=cursor">
					  ...
					  <img src="../img/caja.png" width="80" height="77" border="1" onClick="efectuarpago(<? echo $codfactura?>,<? echo $codcliente?>,<? echo $preciototal?>)" onMouseOver="style.cursor=cursor" title="Efectuar pago">
				        </div>
