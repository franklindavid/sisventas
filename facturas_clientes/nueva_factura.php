	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm_nf" class="header">INSERTAR FACTURA </div>
					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
							...
							<option value="0">Seleccione un Vendedor</option>
								<?php
								while ($contador < mysql_num_rows($res_vendedores)) { ?>
								<option value="<?php echo mysql_result($res_vendedores,$contador,"codvendedor")?>"><?php echo mysql_result($res_vendedores,$contador,"nombrevendedor")?></option>
								<? $contador++;
								} ?>				
								</select>							</td>
				        </tr>
