					...
					button     : "Image1"
					  ...
					  <tr>
						...
						<tr>
					  	...
					  	<!--<tr>
						  <td>Pvp</td>
						  <td colspan="2"><input NAME="qpvp" type="text" class="cajaPequena" id="pvp" size="10" maxlength="10" value=" <echo mysql_result($rs_query,0,"precio_pvp")?>">
						  &#36;</td>
				        </tr>-->
					  <tr>
                      ...
                      <!-- La imagen se edita en la rejilla de productos
					  <tr>
                        <td>Imagen [Formato jpg] [200x200]</td>
                        <td width="20%" align="left" valign="top"><img src="../fotos/<? echo mysql_result($rs_query,0,"imagen")?>" width="160px" height="140px" border="1"></td>
					  </tr>
                      -->
