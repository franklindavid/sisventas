...
//$where1.=" ORDER BY descripcion ASC";
...
<html>
	<head>
		...
		function cambiar_imagen(codarticulo) {
			parent.location.href="cambiar_imagen.php?codarticulo=" + codarticulo + "&cadena_busqueda=<? echo $cadena_busqueda?>";
		}
				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="19%"><div align="left"><? echo mysql_result($res_resultado,$contador,"referencia")?></div></td>
