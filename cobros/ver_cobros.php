				...
				<form id="formdatos" name="formdatos" method="post" action="guardar_cobro.php">
					...
					<? 
						...
						<tr>
						    ...
						    <td width="43%"><? echo $simbolomoneda ?><input type="text" name="pendiente" id="pendiente" value="<? echo number_format($pendiente,2,".","")?>" readonly="yes" class="cajaTotales"></td>
					        <td width="42%" rowspan="14" align="left" valign="top"></td>
						</tr>
						<tr>
				...
				<form id="formulario" name="formulario" method="post" action="frame_cobros.php" target="frame_cobros">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<tr>
						    ...
						    <td width="35%"><input id="fechacobro" type="text" class="cajaPequena" NAME="fechacobro" maxlength="10" value="<? echo $hoy?>"><img src="../img/calendario.png" name="Image3" id="Image3" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'" title="Calendario">
        <script type="text/javascript">
					Calendar.setup({
						...
						<tr>
						    ...
						    <td width="35%"><? echo $simbolomoneda ?><input id="Rimporte" type="text" class="cajaPequena" NAME="Rimporte" maxlength="12"> </td>
