...
while ($contador < mysql_num_rows($rs_lineas)) {
	...
	$sel_tmp="INSERT INTO albalineatmp (codalbaran,numlinea,codfamilia,codigo,cantidad,precio,importe,dcto) VALUES ('$codalbarantmp','','$codfamilia','$codigo','$cantidad','$precio','$importe','$dcto')";
	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">INSERTAR GUIA DE DESPACHO </div>
				<div id="frmBusqueda">
        ...
        <script type="text/javascript">
					...
					button     : "Image1"
				            ...
				            <td width="3%">IGV</td>
				            <td width="64%"><input NAME="iva" type="text" class="cajaPequena" id="iva" size="5" maxlength="5" value="<? echo $ivaimp?>" onChange="cambio_iva()" value="<? echo $iva?>"> %</td>
						</tr>
						<tr>
