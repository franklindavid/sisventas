...
<html>
	<head>
		...
		function efectuarpago(bbcodfactura,codcliente,importe) {
			miPopup = window.open("efectuarpago.php?bbcodfactura="+bbcodfactura+"&codcliente="+codcliente+"&importe="+importe,"miwin","width=500,height=370,scrollbars=yes");	
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">VER BOLETA </div>
				<div id="frmBusqueda">
				...
				<div id="botonBusqueda">
					<div align="center">
					 ...
					 <img src="../img/botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimir(<? echo $bbcodfactura?>)" onMouseOver="style.cursor=cursor">
					  ...
					  <img src="../img/caja.png" width="80" height="77" border="1" onClick="efectuarpago(<? echo $bbcodfactura?>,<? echo $codcliente?>,<? echo $preciototal?>)" onMouseOver="style.cursor=cursor" title="Efectuar pago">
				        </div>
