...
$sel_alb="SELECT * FROM eefacturas WHERE bbcodfactura='$bbcodfactura'";
...
$remito=mysql_result($rs_alb,0,"remito");
$numfactura=mysql_result($rs_alb,0,"numfactura");
...
$fechahoy=date("Y-m-d");
$sel_albaran="INSERT INTO eefacturastmp (bbcodfactura,fecha) VALUE ('','$fechahoy')";
$rs_albaran=mysql_query($sel_albaran);
$bbcodfacturatmp=mysql_insert_id();

$sel_lineas="SELECT * FROM eefactulinea WHERE bbcodfactura='$bbcodfactura' ORDER BY numlinea ASC";
...
while ($bbcontador < mysql_num_rows($rs_lineas)) {
	...
	$precio=mysql_result($rs_lineas,$bbcontador,"precio");
	$importe=mysql_result($rs_lineas,$bbcontador,"importe");
	$baseimponible=$baseimponible+$importe;
	$dcto=mysql_result($rs_lineas,$bbcontador,"dcto");
	$bbsel_tmp="INSERT INTO eefactulineatmp (bbcodfactura,numlinea,codfamilia,codigo,cantidad,precio,importe,dcto) VALUES ('$bbcodfacturatmp','','$codfamilia','$codigo','$cantidad','$precio','$importe','$dcto')";
	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">INSERTAR BOLETA</div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="guardar_factura.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
				            ...
				            <td width="3%">RUC</td>
				            <td width="64%"><input NAME="nif" type="text" class="cajaMedia" id="nif" size="20" maxlength="15" value="<? echo $nif?>" readonly>
							<div style="margin:0 10px 6px 0; float:right;">N&deg; de Remito  <input style="margin:0 0 0 5px;" name="remito" id="remito" type="text" value="<?=$remito?>"></div>
							</td>
						</tr>
						<? $hoy=date("d/m/Y"); ?>
						<tr>
							<td width="6%">Fecha</td>
						    <td width="27%"><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10" maxlength="10" value="<? echo implota($fecha)?>" readonly> <img src="../img/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					...
					button     : "Image1"
				         ...
				         <td width="3%">IGV</td>
				         <td width="64%"><input NAME="iva" type="text" class="cajaPequena" id="iva" size="5" maxlength="5" onChange="cambio_iva()" value="<? echo $iva?>">%
						 <div style="margin:0 10px 6px 0; float:right;">N&deg; de Factura <input name="numfactura" id="numfactura" type="text" value="<?=$numfactura?>"></div>
						 </td>
						</tr>
						<tr>
			  ...
			  <input id="bbcodfacturatmp" name="bbcodfacturatmp" value="<? echo $bbcodfacturatmp?>" type="hidden">
