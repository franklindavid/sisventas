...
$fechahoy=date("Y-m-d");
$sel_fact="INSERT INTO facturastmp (bbcodfactura,fecha) VALUE ('','$fechahoy')";
...
if ($setnumbol==1)
{
	$sel_articulos="UPDATE facturastmp SET bbcodfactura='$numeracionboleta' WHERE bbcodfactura='$bbcodfacturatmp'";
