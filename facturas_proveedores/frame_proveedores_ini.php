...
function pon_prefijo(pref,nombre) {
	parent.opener.document.form_busqueda.codproveedor.value=pref;
...
<? if ($nrs>0) { ?>
		...
		<?php
			for ($i = 0; $i < mysql_num_rows($rs_tabla); $i++) {
				$codproveedor=mysql_result($rs_tabla,$i,"codproveedor");
        ...
        <div align="left"><?php echo utf8_encode($nombre);?></div></td>
					...
					<td align="center"><div align="center"><a href="javascript:pon_prefijo(<?php echo $codproveedor?>,'<?php echo $nombre?>')"><img src="../img/convertir.png" border="0" title="Seleccionar"></a></div></td>					
				</tr>
			<?php }
		?>
  </table>
