...
<html>
	<head>
		...
		function imprimir() {
       	...
       	window.open("../fpdf/imprimir_copiaseguridad.php?fechainicio="+fechainicio+"&denominacion="+denominacion+"&fechafin="+fechafin);
	...
	<body onLoad="inicio()">
        ...
        <script type="text/javascript">
					...
					button     : "Image1"
					  ...
					  <tr>
						  <td>Fecha de fin</td>
						  <td><input id="fechafin" type="text" class="cajaPequena" NAME="fechafin" maxlength="10" value="<? echo $hoy?>" readonly><img src="../img/calendario.png" name="Image2" id="Image2" width="16" height="16" border="0" id="Image1" onMouseOver="this.style.cursor='pointer'" title="Calendario">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "fechafin",
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
				...
				<div id="cabeceraResultado" class="header">
					RELACI&Oacute;N DE COPIAS DE SEGURIDAD</div>
				<div id="frmResultado">
