			...
			<div id="zonaContenido">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						...
						<tr>
							<td>Nombre</td>
							<td><input id="nombreentidad" name="nombreentidad" type="text" class="cajaGrande" maxlength="20" value="<? echo $nombreentidad?>"></td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						</tr>
					</table>
			 	...
			 	<div id="botonBusqueda">
			 	  ...
			 	  <img src="../img/botonlimpiar.jpg" width="69" height="22" border="1" onClick="limpiar()" onMouseOver="style.cursor=cursor">
					 <img src="../img/botonnuevaentidad.jpg" width="161" height="22" border="1" onClick="nueva_entidad()" onMouseOver="style.cursor=cursor">
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
			  	<tr>
				<td width="50%" align="left">N de entidades bancarias encontradas <input id="filas" type="text" class="cajaPequena" NAME="filas" maxlength="5" readonly></td>
				<td width="50%" align="right">Mostradas <select name="paginas" id="paginas" onChange="paginar()">
		          </select></td>
			  </table>
				</div>
				<div id="cabeceraResultado" class="header">
					RELACI&Oacute;N DE ENTIDADES BANCARIAS </div>
				<div id="frmResultado">
