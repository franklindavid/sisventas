...
CREATE TABLE IF NOT EXISTS `albaranestmp` (
  ...
  `fecha` date NOT NULL DEFAULT '0000-00-00',
  PRIMARY KEY (`codalbaran`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='Temporal de albaranes para controlar acceso simultaneo' AUTO_INCREMENT=4 ;
...
INSERT INTO `cobros` (`id`, `codfactura`, `bbcodfactura`, `codcliente`, `importe`, `codformapago`, `numdocumento`, `fechacobro`, `observaciones`) VALUES
...
(1, '', '', '', '', 500, NULL, 0, NULL, 'NO', 'Factura v3chile.jpg', 'SI', 'logo.jpg', 10, 18, 'Soles', 'S/.', 'S/.', 'Farmavicky', 'Botica', '065- 458596', 'Calle Progeso # 125', 'CENTRO', 'Iquitos', '10427467495', '123', '10427467495', NULL, '');
...
(17, 'Jose Calderon', 'jcalderon', '3b47a4b2a2b8bf1653152da3b2544cfe', '', 2597, '2013-09-03', 2, 1),
(16, 'Linda Perez', 'lperez', 'd383b71f075caa4670e99d83e46e26d6', '', 4595, '2013-09-02', 2, 1),
(12, 'Selena Gomez', 'sgomez', '1a6e6c6fc20011bd4f81eab38975f4c6', '', 1124, '2013-09-02', 2, 1),
(13, 'Francisco Terrones', 'fterrones', 'e10adc3949ba59abbe56e057f20f883e', '', 5888, '2013-09-02', 1, 1),
(14, 'Rey Terrones', 'rterrones', '8ec71d8d4b195691b59c9d0b5aa3bee6', '', 1266, '2013-09-02', 1, 1),
(18, 'Tito Castillo', 'tcastillo', 'e10adc3949ba59abbe56e057f20f883e', '', 4003, '2013-09-03', 1, 1),
(19, 'Luis Soria', 'lsoria', '5186c4ebcd16f8023fa37c1cc5d30a8b', '', 6950, '2013-09-03', 2, 1),
(20, 'Luis Mori', 'lmori', '0aa37b524c4fb8c931a7bdaf577ff3aa', '', 5565, '2013-09-03', 1, 1),
(21, 'Gerardo Puelles', 'gpuelles', 'ccc56f017b25f1f72512ee618bc62c45', '', 2752, '2013-09-03', 2, 1);
