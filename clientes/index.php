			...
			<div id="zonaContenido">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						...
						<tr>
							...
							<td><input id="nombre" name="nombre" type="text" class="cajaGrandeNombre" maxlength="55" value="<? echo $nombre?>"></td>
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
				...
				<div id="cabeceraResultado" class="header">
					...
					RELACI&Oacute;N DE CLIENTES </div>
				...
				<div id="div">
				  <iframe style="margin: 0 0 0 8px;" width="100%" height="250" id="frame_rejilla" name="frame_rejilla" frameborder="0">
                  <ilayer height="250" id="frame_rejilla" name="frame_rejilla"></ilayer>
				  </iframe>
